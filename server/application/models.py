...
class Requests(models.Model):
    ...
    # Stores the model (version number) that was used when making the prediction
    # We store this as a local column instead of a foreign key to allow keeping historical data
