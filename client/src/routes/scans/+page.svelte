...
<div class="h-screen flex flex-col">
  ...
  <div
    class="flex-1 w-full p-4 sm:p-6 flex flex-col items-center overflow-y-auto"
  >
    <h1 class="text-secondary text-xl sm:text-2xl font-extralight mb-4">
      Scan History
    </h1>
      ...
      <div class="overflow-x-auto w-full">
        <table class="min-w-full">
          <thead class="bg-primary text-white rounded-t-lg">
            <tr>
              <th
                class="border-b border-gray-200 p-3 sm:p-4 text-left font-light"
                >Date</th
              >
              <th
                class="border-b border-gray-200 p-3 sm:p-4 text-left font-light"
              ...
              >
              <th
                class="border-b border-gray-200 p-3 sm:p-4 text-center font-light"
                >Actions</th
              >
            </tr>
          </thead>
          <tbody>
            {#each scanHistory as scan (scan.id)}
              <tr
                class="even:bg-gray-50 odd:bg-white hover:bg-gray-100 transition-colors"
              >
                <td
                  class="border-b border-gray-200 p-3 sm:p-4 text-tertiary text-sm sm:text-base"
                  >{scan.date}</td
                >
                <td
                  class="border-b border-gray-200 p-3 sm:p-4 text-tertiary text-sm sm:text-base"
    ...
    {:else}
      <p class="text-tertiary mt-10">
        You have no scans yet. Start by uploading an image of your skin for
        analysis.
      </p>
    {/if}
