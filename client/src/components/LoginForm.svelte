...
<div class="flex flex-col max-w-md w-full text-center justify-center">
  ...
  <div class="mb-4">
    <input type="username" bind:value={username} placeholder="Username" class="w-full p-2 border border-gray-300 rounded-md outline-none mt-1 focus:border-secondary">
  </div>
  <div class="mb-4">
