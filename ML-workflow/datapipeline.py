...
def clean_data(df):
    ...
    valid_localization = ['scalp', 'ear', 'face', 'back', 'trunk', 'chest', 'upper extremity', 'abdomen'
    ...
    df['age'] = pd.to_numeric(df['age'], errors='coerce') # Makes sure Age is a numerical value 
...
preprocessed_data = pre_process_data()
