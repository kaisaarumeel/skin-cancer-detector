<div class="flex flex-col max-w-md w-full text-center justify-center">
    <h2 class="text-3xl font-light text-secondary mb-6">Sign up here</h2>
    ...
    <button class="w-full p-3 bg-primary text-white font-light rounded-md cursor-pointer mt-4 transition-colors hover:bg-secondary shadow-l">Sign up</button>
</div>